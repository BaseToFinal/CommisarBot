...
SOVIET_FIRST_NAMES = [
    ...
    "Aleksei", "Grigori", "Fyodor", "Semyon", "Timofei",
    "Vasili", "Georgi", "Denis", "Roman", "Artyom",
    "Valeri", "Vadim", "Vyacheslav", "Ruslan", "Maksim",
    "Arkadi", "Innokenti", "Kirill", "Rostislav", "Yaroslav",
    "Zakhar", "Matvei", "Nikita", "Radion", "Savva",
    "Taras", "Trofim", "Ustin", "Veniamin", "Yakov",
    "Anton", "Bogdan", "Danil", "Egor", "Filipp",
    "Gleb", "Ilya", "Kondrat", "Lavr", "Miron",
    "Nazar", "Ostap", "Prokhor", "Rodion", "Stanislav",
    "Timur", "Vitali", "Vsevolod", "Yefim", "Zinovi",
    "Adam", "Bronislav", "Dorofei", "Emelyan", "Fadei",
    "Gavriil", "Herman", "Ippolit", "Karp", "Lev",
    "Maksimilian", "Nestor", "Onufri", "Panteleimon", "Rafail",
    "Sevastyan", "Terenti", "Vlas", "Yermolai", "Zosima",
    "Avdei", "Bazhen", "Feliks", "Gennady", "Iosif",
    "Kuzma", "Lukyan", "Modest", "Naum", "Osip",
]
...
SOVIET_LAST_NAMES = [
    ...
    "Smirnov", "Sidorov", "Mikhailov", "Fyodorov", "Andreev",
    "Alekseev", "Nikitin", "Vinogradov", "Egorov", "Pavlov",
    "Kozlovsky", "Kolesnikov", "Sorokin", "Frolov", "Zhukov",
    "Kudryavtsev", "Baranov", "Kalinin", "Chernov", "Golubev",
    "Rogov", "Simonov", "Bykov", "Mironov", "Shishkin",
    "Solovyov", "Ustinov", "Grigoriev", "Timofeev", "Kruglov",
    "Rybakov", "Denisov", "Yakovlev", "Antonov", "Karpov",
    "Filippov", "Nazarov", "Shvetsov", "Gusev", "Panin",
    "Voronin", "Isaev", "Klimov", "Kravtsov", "Loginov",
    "Maslov", "Nikiforov", "Osipov", "Ryzhov", "Savelyev",
    "Titov", "Vlasov", "Zhdanov", "Belyaev", "Chistyakov",
    "Drozdov", "Efimov", "Gavrilov", "Ilyin", "Kalashnikov",
    "Lapin", "Mishin", "Nesterov", "Ognev", "Polyakov",
    "Rakov", "Sazonov", "Tarasov", "Ushakov", "Vorobyov",
    "Yashin", "Zaharov", "Aksyonov", "Burov", "Chekhov",
    "Danilov", "Eliseev", "Gorbachev", "Krylov", "Medvedev",
]
